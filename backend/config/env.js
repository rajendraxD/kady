...
export const mongoUri = def("MONGO_URI", "mongodb://localhost:27017/kady-hiring-portal");
export const jwtSecret = def("JWT_SECRET", "kady-admin-secret-key-change-in-production");
export const smtp = {
  host: def("SMTP_HOST"),
...
const env = { port, mongoUri, jwtSecret, smtp, nodeEnv, isProd, isDev };
export { env };
export default env;
